...
# how statistically good should our results be? 
num_messages = 100
...
log.write("max_failures: #{max_failures}\n")
log.write("lambda: 256\n")
log.write("world_width: #{world_width}\n")
log.write("world_height: #{world_height}\n")
log.write("broadcast_radius: #{broadcast_radius}\n")
log.write("num_messages: #{num_messages}\n")
log.write("num_nodes: #{num_nodes}\n")

log.write("Experiment,replicas,put recall, get recall\n")
log.flush()
i = 0
results = []
(1..50).each { |replicas|
         ...
         puts "-------------------------------------------------------------------------------------"
         puts "Experiment: #{replicas} replicas\n"
         puts "-------------------------------------------------------------------------------------"
        ...
        log.write("#{i},#{replicas},#{put_recall_avg}, #{get_recall_avg}\n")
        log.flush()
        i += 1
